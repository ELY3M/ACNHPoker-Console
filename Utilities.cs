    ...
    public static class Utilities
    {
        ...
        public static byte[] GetInventoryBank(Socket socket, int slot)
        {
            ...
            lock (botLock)
            {
                    ...
                    if (b == null)
                    {
                        Console.WriteLine("Wait something is wrong here!? \n\n GetItemSlotUIntAddress(" + slot + ")");
                    }
        ...
        public static void SpawnItem(Socket socket, int slot, String value, String amount)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"SpawnRecipe");
                }
            }
        }
        ...
        public static void SpawnFlower(Socket socket, int slot, String value, String flowerValue)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"SpawnFlower");
                }
            }
        }
        ...
        public static byte[] PeekAddress(Socket socket, UInt32 address, int size)
        {
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"peekAddress");
                    return null;
                }
            }
        }
        ...
        public static void PokeAddress(Socket socket, string address, string value)
        {
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"pokeAddress");
                }
            }
        }
        ...
        public static void PokeMainAddress(Socket socket, string address, string value)
        {
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"pokeMainAddress");
                }
            }
        }
        ...
        public static byte[] ReadByteArray(Socket socket, long initAddr, int size, ref int counter)
        {
            ...
            {
                Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"ReadByteArray");
                return null;
            }
        }
        ...
        public static void ReadUInt64Array(Socket socket, long initAddr, UInt64[] buffer, int size, int offset = 0)
        {
            ...
            {
                Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"ReadUInt64Array");
            }
        }
...
*/
        ...
        public static byte[] GetReaction(Socket socket, int player)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"getReaction");
                    return null;
                }
            }
        }
        ...
        public static void SetReaction(Socket socket, int player, string reactionFirstHalf, string reactionSecondHalf)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"setReaction");
                }
            }
        }
        ...
        public static byte GetHouseOwner(Socket socket, int num, ref int counter)
        {
            ...
            lock (botLock)
            {
                    ...
                    if (b == null)
                    {
                        Console.WriteLine(@"Wait something is wrong here!? HouseOwner");
                        return 0xDD;
                    }
        ...
        public static void SetCatchphrase(Socket socket, int num, byte[] pharse)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"SetCatchphrase");
                }
            }
        }
        ...
        public static byte GetVillagerFlag(Socket socket, int num, uint offset)
        {
            lock (botLock)
            {
                    ...
                    if (b == null)
                    {
                        Console.WriteLine(@"Wait something is wrong here!? VillagerFlag");
                    }
        ...
        public static byte GetVillagerHouseFlag(Socket socket, int num, uint offset, ref int counter)
        {
            ...
            lock (botLock)
            {
                    ...
                    if (b == null)
                    {
                        Console.WriteLine(@"Wait something is wrong here!? VillagerHouseFlag");
                    }
        ...
        public static void SetMoveout2(Socket socket, int num, string MoveoutFlag = "2", string ForceMoveoutFlag = "1")
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"SetMoveout");
                }
            }
        }
        ...
        public static void SetFriendship(Socket socket, int num, int player, string FriendshipFlag = "FF")
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"SetFriendship");
                }
            }
        }
        ...
        public static void DropItem(Socket socket, long address, string itemId, string count, string flag0, string flag1)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"dropItem");
                }
            }
        }
        ...
        public static void DeleteFloorItem(Socket socket, long address)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"deleteFloorItem");
                }
            }
        }
        ...
        public static byte[] GetMapLayer(Socket socket, long address, ref int counter)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"getMapLayer");
                    return null;
                }
            }
        }
        ...
        public static byte[] GetAcre(Socket socket)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"getAcre");
                    return null;
                }
            }
        }
        ...
        public static void SendAcre(Socket socket, byte[] acre, ref int counter)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"sendAcre");
                }
            }
        }
        ...
        public static void SendPlaza(Socket socket, byte[] plaza, ref int counter)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"sendPlaza");
                }
            }
        }
        ...
        public static void SendBuilding(Socket socket, byte[] building, ref int counter)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"sendBuilding");
                }
            }
        }
        ...
        public static byte[] GetBuilding(Socket socket)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"getBuilding");
                    return null;
                }
            }
        }
        ...
        public static void SendTerrain(Socket socket, byte[] terrain, ref int counter)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"sendTerrain");
                }
            }
        }
        ...
        public static void SendCustomMap(Socket socket, byte[] CustomMap, ref int counter)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"sendCustomMap");
                }
            }
        }
        ...
        public static byte[] GetTerrain(Socket socket)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"getTerrain");
                    return null;
                }
            }
        }
        ...
        public static byte[] GetActivate(Socket socket, long address, ref int counter)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"getActivate");
                    return null;
                }
            }
        }
        ...
        public static byte[] GetCustomDesignMap(Socket socket, ref int counter)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"getCustomDesignMap");
                    return null;
                }
            }
        }
        ...
        public static byte[] GetMyDesign(Socket socket, ref int counter)
        {
            ...
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"getMyDesign");
                    return null;
                }
            }
        }
        */
        ...
        public static void SetTextSpeed(Socket socket, bool chi)
        {
            lock (botLock)
            {
                ...
                {
                    Console.WriteLine(@"Exception, try restarting the program or reconnecting to the switch.", @"SetTextSpeed");
                }
            }
        }
        ...
        public static bool IsAboutToSave(Socket socket, int NeedSecond, int saveTime = 0, bool ignoreProtection = false)
        {
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine(ex.Message, "This is utterly fucking retarded.");
                return false;
            }
        }
